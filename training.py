...
def train_kfold(model_factory, full_dataset, scenario_to_samples, batch_size=64, num_epochs=100, device='cuda', use_smote=False):
    ...
    print("="*70)
    print(f"SMOTE: {'Enabled' if use_smote else 'Disabled (recommended)'}")
...
def train_kfold(model_factory,full_dataset, scenario_to_samples: Dict[int, List[int]], batch_size: int, num_epochs: int, device: str):
