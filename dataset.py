...
def create_complete_dataset( vit_results: Dict, output_dir: str = './processed_dataset') -> Dict:
    print("\n" + "="*70)
    print("PHASE 7: CREATE COMPLETE DATASET")
    print("="*70)
    ...
    validation = _validate_dataset(
        X_train_spatial, X_train_rainfall, y_train,
        X_test_spatial, X_test_rainfall, y_test
    )
...
def _validate_dataset(X_train_spatial, X_train_rainfall, y_train, X_test_spatial, X_test_rainfall, y_test ) -> Dict:
    checks = {}
